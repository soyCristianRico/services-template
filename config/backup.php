...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            /*
             * Derived from APP_NAME so a cloned site does not have to remember to
             * change it, and so two sites sharing a drive folder stay apart.
             */
            'filename_prefix' => Str::slug((string) env('APP_NAME', 'laravel')).'-backup-',
